...
//        lifecycleScope.launch(Dispatchers.IO) {
//            try {
//                // 🔹 0. 서버에서 전체 운동 리스트 받아오기
//                val allExercisesRes = RetrofitClient.exerciseApi.getAllExercises()
//                if (allExercisesRes.isSuccessful) {
//                    val serverList = allExercisesRes.body() ?: emptyList()
//
//                    val exercises = serverList.map {
//                        Exercise(
//                            id = it.id,
//                            name = it.name,
//                            part = it.part,
...
//                    Log.d("SyncRoom", "📥 전체 운동 ${exercises.size}개 Room에 동기화 완료")
//                } else {
//                    Log.e("SyncRoom", "❌ 전체 운동 가져오기 실패: ${allExercisesRes.code()}")
//                }
//
//                // 🔹 1. 오늘의 운동 계획 받아오기
...
//
//            } catch (e: Exception) {
//                Log.e("SyncRoom", "❗ 전체 동기화 중 예외 발생: ${e.message}")
//            }
//        }
//    }
//}
